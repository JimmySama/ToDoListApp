...
},{}],"DOMS.js":[function(require,module,exports) {
"use strict";
...
var listForm = document.querySelector('.list-form'); // const deleteBtns = document.querySelectorAll('.inbox__icon--delete');
...
exports.inbox = inbox;
var addForm = document.querySelector('.form__form');
...
var DOMs = _interopRequireWildcard(require("./DOMS"));
...
//Global variables
var markups = []; // localStorage.setItem('items', []);
