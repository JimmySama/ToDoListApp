...
DOMs.today.textContent = "".concat(month[today.getMonth()], " ").concat(today.getDay(), ", ").concat(today.getFullYear(), " "); // DOMs.inbox.textContent = `INBOX(${DOMs.deleteBtnsArr.length})`;
//DOMs Manipulation
